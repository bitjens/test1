...
> Åbn denne side på [https://bitjens.github.io/test1/](https://bitjens.github.io/test1/)
...
* søg efter **https://github.com/bitjens/test1**, og importer

## Rediger dette projekt ![Byggestatus-badge](https://github.com/bitjens/test1/workflows/MakeCode/badge.svg)

Sådan redigerer du dette lager i MakeCode.

* åbn [https://makecode.microbit.org/](https://makecode.microbit.org/)
* klik på **Importer**, og klik derefter på **Import-URL-adresse**
* indsæt **https://github.com/bitjens/test1**, og klik på Importer
...
![En genereret visning af blokkene](https://github.com/bitjens/test1/raw/master/.github/makecode/blocks.png)
